...
public class EditTodoItemDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_item_todo_edit, null);
        ...
        // populate the fields with existing item info so the user can edit what they intend to
            ...
            public void onClick(View view)
            {
                ...
                if(name.isEmpty())
                {
                ...
                else
                    {
                        ...
                        callingActivity.updateTodoItem(item);
                        dismiss();
                    }
            }
        }
